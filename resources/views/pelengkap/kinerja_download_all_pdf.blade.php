...
<body>
    ...
    <div class="kwitansi-container @if(!$loop->last) page-break @endif">
        ...
        $totalAmount = ($data['totalAmount'] > 0) ? $data['totalAmount'] : ($kwitansi->kinerjaBukuKasUmum->total_transaksi_kotor ?? 0);
            ...
            <table class="info-table">
                <tr>
                    ...
                    <td class="info-content">
                        <span class="bordered-content">{{ $kwitansi->kinerjaBukuKasUmum->id_transaksi ?? 'KW-'.$kwitansi->id
                            }}</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="separator">:</td>
                    <td class="info-content info-code-width">{{ $kwitansi->kinerjaPenganggaran->tahun_anggaran ?? '-' }}</td>
        ...
        <div class="receipt-info">
            <table>
                <tr>
                    ...
                    <td width="78%"><span class="label-col">Bendahara Dana {{ $sumberDana ?? 'BOSP Reguler' }} {{
                ...
                <tr>
                    ...
                    <td><span class="label-col">:</span></td>
                    <td><span class="label-col">{{ $kwitansi->kinerjaBukuKasUmum->uraian_opsional ??
                            $kwitansi->kinerjaBukuKasUmum->uraian }}</span></td>
                </tr>
            </table>
        </div>
        ...
        <div class="detail-table-container">
            <table>
                ...
                <tbody>
                    @php
                    $uraianDetails = $kwitansi->kinerjaBukuKasUmum->uraianDetails ?? collect([]);
                    @endphp
                    ...
                    @else
                    <tr>
                        <td>{{ $kwitansi->kinerjaBukuKasUmum->uraian_opsional ?? $kwitansi->kinerjaBukuKasUmum->uraian }}</td>
                        <td></td>
                        <td></td>
                ...
                <tr>
                    <td>
                        <div class="signature-block" style="margin-right: 200px;">
                            ...
                            <p class="name">{{ $kwitansi->kinerjaPenganggaran->bendahara }}</p>
                            <p class="nip">NIP. {{ $kwitansi->kinerjaPenganggaran->nip_bendahara }}</p>
                        </div>
                    </td>
                    <td>
        ...
        <div class="kepsek-block">
            ...
            <p class="name">{{ $kwitansi->kinerjaPenganggaran->kepala_sekolah }}</p>
            <p class="nip">NIP. {{ $kwitansi->kinerjaPenganggaran->nip_kepala_sekolah }}</p>
        </div>
    </div>
    @endforeach
</body>
