            ...
            <tr>
                ...
                <td>
                    <div style="border-top: 1px solid #000; border-bottom: 1px solid #000; padding: 2px 0; display: inline-block;">
                        : {{ $kwitansi->kinerjaBukuKasUmum->id_transaksi ?? 'KW-'.$kwitansi->id }}
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>:</td>
                <td colspan="3">{{ $kwitansi->kinerjaPenganggaran->tahun_anggaran ?? '-' }}</td>
            </tr>
            <tr>
                <td>Program</td>
                <td>:</td>
        ...
        <table class="signature-table">
            <tr>
                <td>
                    ...
                    <span style="font-size: 9pt;">NIP. {{ $kwitansi->kinerjaPenganggaran->nip_bendahara }}</span>
                </td>
                <td>
                    <br>
                    Kepala Sekolah
                    ...
                    <span style="font-size: 9pt;">NIP. {{ $kwitansi->kinerjaPenganggaran->nip_kepala_sekolah }}</span>
                </td>
                <td>
                    <br>
                    Yang Menerima
