                ...
                <table style="width: 100%; font-size: {{ $fontSize ?? '10pt' }};">
                    <tbody>
                        ...
                        <tr>
                            <td>Uraian</td>
                            <td>:</td>
                            <td colspan="2">{{ $item['silpaBukuKasUmum']->uraian_opsional ?? '-' }}</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>Sumber Dana</td>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item['silpaBukuKasUmum']->nama_penerima_pembayaran ?? '-' }}</td>
                        <td class="text-center">{{ $item['silpaBukuKasUmum']->uraianDetails->first()->volume ?? '-' }}</td>
                        <td class="text-center">{{ $item['silpaBukuKasUmum']->uraianDetails->first()->satuan ?? '-' }}</td>
                        <td class="currency" style="text-align: right;">Rp {{
                            number_format($item['silpaBukuKasUmum']->uraianDetails->first()->harga_satuan ?? 500000, 0, ',',
                            '.') }}</td>
                ...
                <tr>
                    <td style="font-size: {{ $fontSize ?? '10pt' }};">
                        ...
                        <div class="signature-name">
                            {{ $item['silpaPenganggaran']->kepala_sekolah ?? '-' }}
                        </div>
                        <div class="signature-nip">
                            NIP. {{ $item['silpaPenganggaran']->nip_kepala_sekolah ?? '-' }}
                        </div>
                    </td>
                    <td style="font-size: {{ $fontSize ?? '10pt' }};">
                        ...
                        <div class="signature-name">
                            {{ $item['silpaPenganggaran']->bendahara ?? '-' }}
                        </div>
                        <div class="signature-nip">
                            NIP. {{ $item['silpaPenganggaran']->nip_bendahara ?? '-' }}
                        </div>
                    </td>
                </tr>
            </table>
