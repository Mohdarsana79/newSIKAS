        ...
        <table style="width: 100%; font-size: {{ $fontSize ?? '10pt' }};">
            <tbody>
                ...
                <tr>
                    <td>Uraian</td>
                    <td>:</td>
                    <td colspan="2">{{ $tandaTerima->silpaBukuKasUmum->uraian_opsional ?? '-' }}</td>
                    <td></td>
                </tr>
                <tr>
                    <td>Sumber Dana</td>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $tandaTerima->silpaBukuKasUmum->nama_penerima_pembayaran ?? '-' }}</td>
                    <td class="text-center">{{ $tandaTerima->silpaBukuKasUmum->uraianDetails->first()->volume ?? '-' }}</td>
                    <td class="text-center">{{ $tandaTerima->silpaBukuKasUmum->uraianDetails->first()->satuan ?? '-' }}</td>
                    <td class="currency" style="text-align: right;">Rp {{
                        number_format($tandaTerima->silpaBukuKasUmum->uraianDetails->first()->harga_satuan ?? 500000, 0, ',',
                        '.') }}</td>
            ...
            <tr>
                <td>
                    ...
                    <div class="signature-name">
                        {{ $tandaTerima->silpaPenganggaran->kepala_sekolah ?? '-' }}
                    </div>
                    <div class="signature-nip">
                        NIP. {{ $tandaTerima->silpaPenganggaran->nip_kepala_sekolah ?? '-' }}
                    </div>
                </td>
                <td>
                    {{ $tanggalLunas }}<br>
                    ...
                    <div class="signature-name">
                        {{ $tandaTerima->silpaPenganggaran->bendahara ?? '-' }}
                    </div>
                    <div class="signature-nip">
                        NIP. {{ $tandaTerima->silpaPenganggaran->nip_bendahara ?? '-' }}
                    </div>
                </td>
            </tr>
        </table>
