        ...
        <table class="info-table" style="width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td rowspan="2" style="text-align: right; vertical-align: top;">
                    <div class="no-box">
                        No. {{ str_pad($kwitansi->kinerjaBukuKasUmum->id_transaksi ?? $kwitansi->id, 3, '0', STR_PAD_LEFT) }}
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>:</td>
                <td>{{ $kwitansi->kinerjaPenganggaran->tahun_anggaran ?? '-' }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <table style="width: 100%; border-collapse: collapse; border: 2px solid black;">
                        ...
                        <tbody>
                            @if($kwitansi->kinerjaBukuKasUmum && $kwitansi->kinerjaBukuKasUmum->uraianDetails)
                                @foreach($kwitansi->kinerjaBukuKasUmum->uraianDetails as $detail)
                                <tr>
        ...
        <table class="signature-table" style="margin-top: 30px;">
            <tr>
                <td>
                    ...
                    Kepala Sekolah
                    <br><br><br><br><br><br>
                    <b>{{ $kwitansi->kinerjaPenganggaran->kepala_sekolah ?? '-' }}</b><br>
                    NIP. {{ $kwitansi->kinerjaPenganggaran->nip_kepala_sekolah ?? '-' }}
                </td>
                <td>
                    {{ $tanggalLunas ?? '-' }}<br>
                    Bendahara {{ $sumberDana ?? 'BOSP Reguler' }}
                    <br><br><br><br><br><br>
                    <b>{{ $kwitansi->kinerjaPenganggaran->bendahara ?? '-' }}</b><br>
                    NIP. {{ $kwitansi->kinerjaPenganggaran->nip_bendahara ?? '-' }}
                </td>
                <td>
                    <br>
                    Menerima
                    <br><br><br><br><br><br>
                    <b>{{ $kwitansi->kinerjaBukuKasUmum->penerima ?? '.....................................' }}</b>
                </td>
            </tr>
        </table>
    </div>
