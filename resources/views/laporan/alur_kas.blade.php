...
<body>
    ...
    <table class="no-border-table" style="width: 100%; margin-top: 30px;">
        <tr>
            ...
            <td style="width: 50%; text-align: center; vertical-align: top;">
                <div>{{ $anggaran['sekolah']['kabupaten_kota'] ?? '...' }}, {{ $anggaran['tanggal_cetak'] ? \Carbon\Carbon::parse($anggaran['tanggal_cetak'])->locale('id')->translatedFormat('d F Y') : '' }}</div>
