...
<body>
    ...
    <p style="text-align: justify; margin-top: 10px;">
        Saya yang bertanda tangan dibawah ini menyatakan bahwa bertanggung jawab secara formal dan material atas kebenaran realisasi penerimaan dan pengeluaran Dana SiLPA BOSP Kinerja serta kebenaran perhitungan dan setoran pajak yang telah dipungut atas penggunaan Dana SiLPA BOSP Kinerja pada Semester {{ $sptj->tahap }} tahun anggaran {{ $sptj->silpaPenganggaran->tahun_anggaran }} dengan rincian sebagai berikut:
    </p>
    ...
    <table class="content-table">
        ...
        <tr>
            ...
            <td colspan="2">Saldo Awal Dana SiLPA BOSP Kinerja</td>
        ...
        <tr>
            ...
            <td colspan="5">Penerimaan Dana SiLPA BOSP Kinerja</td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <td colspan="5">Pengeluaran Dana SiLPA BOSP Kinerja</td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <td colspan="5">Sisa Dana SiLPA BOSP Kinerja</td>
        </tr>
        <tr>
            <td></td>
