...
<body>
    <div class="header">
        ...
        <div class="subtitle">Semester {{ $lph->semester }} Tahun {{ $lph->kinerjaPenganggaran->tahun_anggaran }}</div>
    </div>
    ...
    <p style="margin-bottom: 5px;">
        Bersama ini kami laporkan realisasi atas penggunaan Dana BOSP Kinerja untuk Semester {{ $lph->semester }} tahun {{ $lph->kinerjaPenganggaran->tahun_anggaran }} sebagai berikut:
    </p>
    ...
    <table class="content-table">
        ...
        <tbody>
            ...
            <tr>
                <td></td>
                <td style="padding-left: 20px;">:: BOSP Kinerja</td>
            ...
            <tr>
                <td></td>
                <td style="padding-left: 30px;">:: BOSP Kinerja</td>
    ...
    <div class="page-number">Laporan Penggunaan Hibah Dana BOSP Semester {{ $lph->semester }} Tahun {{ $lph->kinerjaPenganggaran->tahun_anggaran }}</div>
