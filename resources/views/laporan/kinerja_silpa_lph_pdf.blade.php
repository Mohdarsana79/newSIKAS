...
<body>
    <div class="header">
        <div class="title">LAPORAN PENGGUNAAN HIBAH DANA BOSP Kinerja</div>
        <div class="subtitle">Semester {{ $lph->semester }} Tahun {{ $lph->silpaPenganggaran->tahun_anggaran }}</div>
    </div>
    ...
    <p style="margin-bottom: 5px;">
        Bersama ini kami laporkan realisasi atas penggunaan Dana SiLPA BOSP Kinerja untuk Semester {{ $lph->semester }} tahun {{ $lph->silpaPenganggaran->tahun_anggaran }} sebagai berikut:
    </p>
    ...
    <table class="content-table">
        ...
        <tbody>
            ...
            <tr>
                <td></td>
                <td style="padding-left: 20px;">:: SiLPA BOSP Kinerja</td>
            ...
            <tr>
                <td></td>
                <td style="padding-left: 30px;">:: SiLPA BOSP Kinerja</td>
    ...
    <div class="page-number">Laporan Penggunaan Hibah Dana BOSP Semester {{ $lph->semester }} Tahun {{ $lph->silpaPenganggaran->tahun_anggaran }}</div>
