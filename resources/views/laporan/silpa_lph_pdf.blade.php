...
<body>
    ...
    <p style="margin-bottom: 5px;">
        Bersama ini kami laporkan realisasi atas penggunaan Dana SiLPA BOSP Reguler untuk Semester {{ $lph->semester }} tahun {{ $lph->silpaPenganggaran->tahun_anggaran }} sebagai berikut:
    </p>
    ...
    <table class="content-table">
        ...
        <tbody>
            ...
            <tr>
                <td></td>
                <td style="padding-left: 20px;">:: SiLPA BOSP Reguler</td>
            ...
            <tr>
                <td></td>
                <td style="padding-left: 30px;">:: SiLPA BOSP Reguler</td>
