...
<body>
    ...
    <p style="text-align: justify; margin-top: 10px;">
        Saya yang bertanda tangan dibawah ini menyatakan bahwa bertanggung jawab secara formal dan material atas kebenaran realisasi penerimaan dan pengeluaran Dana SiLPA BOSP Reguler serta kebenaran perhitungan dan setoran pajak yang telah dipungut atas penggunaan Dana SiLPA BOSP Reguler pada Semester {{ $sptj->tahap }} tahun anggaran {{ $sptj->silpaPenganggaran->tahun_anggaran }} dengan rincian sebagai berikut:
    </p>
    ...
    <table class="content-table">
        ...
        <tr>
            ...
            <td colspan="2">Saldo Awal Dana SiLPA BOSP Reguler</td>
        ...
        <tr>
            ...
            <td colspan="5">Penerimaan Dana SiLPA BOSP Reguler</td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <td colspan="5">Pengeluaran Dana SiLPA BOSP Reguler</td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <td colspan="5">Sisa Dana SiLPA BOSP Reguler</td>
        </tr>
        <tr>
            <td></td>
