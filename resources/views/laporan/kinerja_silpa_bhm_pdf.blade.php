...
<head>
    ...
    <title>REKAPITULASI REALISASI BELANJA DANA BOSP ( BARANG MODAL / ASET )</title>
    <style>
        @page {
...
<body>
    <div style="position: absolute; top: 0; right: 0; border: 1px solid black; padding: 5px 15px; font-weight: bold; font-size: 14pt;">BHM</div>
    <div class="header">
        <span style="font-size: 1.1em;">REKAPITULASI REALISASI BELANJA DANA BOSP ( BARANG MODAL / ASET )</span><br>
    ...
    <table class="main-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="8" class="text-center" style="padding: 15px;">Tidak ada data BHM untuk periode ini.</td>
                </tr>
            @endforelse
