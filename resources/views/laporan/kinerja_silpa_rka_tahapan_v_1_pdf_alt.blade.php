            ...
            <table class="strict-border">
                <thead>
                    <tr>
                        ...
                        <th rowspan="3" class="text-center" style="width: 10%;">Kode Rekening</th>
                        <th rowspan="3" class="text-center" style="width: 8%;">Kode Program</th>
                        <th rowspan="3" class="text-center">Uraian</th>
                        <th colspan="5" class="text-center">Rincian Perhitungan</th>
                        <th rowspan="3" class="text-center" style="width: 10%;">Jumlah</th>
                        <th colspan="2" rowspan="2" class="text-center">Tahap</th>
                    </tr>
                    <tr>
                        <th rowspan="2" class="text-center" style="width: 5%;">Volume</th>
                        <th colspan="2" class="text-center">Tahap</th>
                        <th rowspan="2" class="text-center" style="width: 6%;">Satuan</th>
                        <th rowspan="2" class="text-center" style="width: 8%;">Tarif Harga</th>
                    </tr>
                    <tr>
                        <th class="text-center" style="width: 4%;">T1</th>
                        <th class="text-center" style="width: 4%;">T2</th>
                                        ...
                                        @if (!empty($uraianProgram['items']))
                                            @foreach ($uraianProgram['items'] as $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center text-string" style="text-align: center; vertical-align: middle;">{{ $uraianKode }}</td>
                                                    <td>{{ $item['uraian'] }}</td>
                                                    ...
                                                    @if ($is_excel ?? false)
                                                        <td class="accounting">{{ number_format($item['harga_satuan'] ?? $item['tarif'] ?? 0, 0, '.', ',') }}</td>
                                                        <td class="accounting font-bold">{{ number_format($item['jumlah'], 0, '.', ',') }}</td>
                                                        <td class="accounting">{{ $item['tahap1'] > 0 ? number_format($item['tahap1'], 0, '.', ',') : '0' }}</td>
                                                        <td class="accounting">{{ $item['tahap2'] > 0 ? number_format($item['tahap2'], 0, '.', ',') : '0' }}</td>
                                                    @else
                                                        <td class="text-right">{{ number_format($item['harga_satuan'] ?? $item['tarif'] ?? 0, 0, ',', '.') }}</td>
                                                        <td class="text-right font-bold">{{ number_format($item['jumlah'], 0, ',', '.') }}</td>
                                                        <td class="text-right">{{ $item['tahap1'] > 0 ? number_format($item['tahap1'], 0, ',', '.') : '0' }}</td>
                                                        <td class="text-right">{{ $item['tahap2'] > 0 ? number_format($item['tahap2'], 0, ',', '.') : '0' }}</td>
                                                    @endif
                                                </tr>
                                            @endforeach
                                        @endif
