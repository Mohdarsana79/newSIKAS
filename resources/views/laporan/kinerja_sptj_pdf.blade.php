...
<body>
    ...
    <p style="text-align: justify; margin-top: 10px;">
        Saya yang bertanda tangan dibawah ini menyatakan bahwa bertanggung jawab secara formal dan material atas kebenaran realisasi penerimaan dan pengeluaran Dana BOSP Kinerja serta kebenaran perhitungan dan setoran pajak yang telah dipungut atas penggunaan Dana BOSP Kinerja pada Semester {{ $sptj->tahap }} tahun anggaran {{ $sptj->kinerjaPenganggaran->tahun_anggaran }} dengan rincian sebagai berikut:
    </p>
    ...
    <table class="content-table">
        ...
        <tr>
            ...
            <td colspan="2">Saldo Awal Dana BOSP Kinerja</td>
        ...
        <tr>
            ...
            <td colspan="5">Penerimaan Dana BOSP Kinerja</td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <td colspan="5">Pengeluaran Dana BOSP Kinerja</td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <td colspan="5">Sisa Dana BOSP Kinerja</td>
        </tr>
        <tr>
            <td></td>
