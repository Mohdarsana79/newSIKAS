...
<html lang="id">
    ...
    <body>
        @foreach ($allData as $month => $rkaBulananData)
            <div style="{{ !$loop->last ? 'page-break-after: always;' : '' }}">
                <div class="header">
                    <h3 class="uppercase font-bold">KERTAS KERJA RENCANA KEGIATAN DAN ANGGARAN SEKOLAH (RKAS) PER BULAN
                        {{ strtoupper($month) }}</h3>
                ...
                <div>
                    ...
                    <table>
                        ...
                        <tbody>
                            @php $no = 1; @endphp
                            @foreach ($rkaBulananData as $programKode => $program)
                                <!-- Program Row -->
                                <tr class="bg-orange">
                                    ...
                                    <td class="text-right font-bold">
                                        {{ number_format($program['jumlah'], 0, ',', '.') }}
                                    </td>
                                </tr>
                                                    ...
                                                    @foreach ($uraianProgram['items'] as $item)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                {{ $item['jumlah'] / ($item['harga_satuan'] > 0 ? $item['harga_satuan'] : 1) }}
                                                            </td>
                            ...
                            <tr class="bg-grey font-bold" style="border-top: 2px solid black;">
                                ...
                                <td class="text-right">
                                    {{ number_format(collect($rkaBulananData)->sum('jumlah'), 0, ',', '.') }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
