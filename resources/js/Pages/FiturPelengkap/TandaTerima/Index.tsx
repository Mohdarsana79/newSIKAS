            ...
            <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
                <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex space-x-2 py-3 overflow-x-auto">
                        <button
                            onClick={() => {
                                if (activeTab !== 'reguler') router.visit(route('tanda-terima.index'));
                            }}
                        ...
                        <button
                            onClick={() => {
                                if (activeTab !== 'kinerja') router.visit(route('kinerja-tanda-terima.index'));
                            }}
                            className={`flex items-center px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 ${
                                activeTab === 'kinerja'
                                    ? 'bg-blue-50 text-blue-700 shadow-sm ring-1 ring-inset ring-blue-700/10 dark:bg-blue-900/30 dark:text-blue-400 dark:ring-blue-400/20'
                        ...
                        <button
                            onClick={() => {
                                if (activeTab !== 'silpa') router.visit(route('silpa-tanda-terima.index'));
                            }}
                            className={`flex items-center px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 ${
                                activeTab === 'silpa'
                                    ? 'bg-blue-50 text-blue-700 shadow-sm ring-1 ring-inset ring-blue-700/10 dark:bg-blue-900/30 dark:text-blue-400 dark:ring-blue-400/20'
                        ...
                        <button
                            onClick={() => {
                                if (activeTab !== 'kinerja_silpa') router.visit(route('kinerja-silpa-tanda-terima.index'));
                            }}
                            className={`flex items-center px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 ${
