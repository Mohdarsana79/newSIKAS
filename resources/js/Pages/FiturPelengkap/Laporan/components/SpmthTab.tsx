...
export default function SpmthTab() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (error.response && error.response.status === 422) {
                ...
                if (errors.nomor_surat) {
                    setValidationMessage(errors.nomor_surat[0]);
                    setIsValidationModalOpen(true);
                } else {
                    showToast('Data tidak valid. Silakan periksa kembali.', 'error');
                }
            } else {
                showToast('Gagal menyimpan data SPMTH.', 'error');
            }
        } finally {
            setIsSaving(false);
        }
    ...
    const confirmDelete = async () => {
        ...
        try {
            ...
            showToast('Data SPMTH berhasil dihapus.', 'success');
        } catch (error) {
            console.error(error);
                ...
                <div className="p-0 overflow-hidden rounded-lg shadow-2xl bg-white dark:bg-gray-800 animate-scale-in">
                    ...
                    <div className="p-8 text-center">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-8">
                            Nomor SPMTH untuk tahap dan tahun anggaran ini sudah terdaftar dalam sistem. Mohon gunakan nomor yang berbeda atau periksa data yang sudah ada.
                        </p>
