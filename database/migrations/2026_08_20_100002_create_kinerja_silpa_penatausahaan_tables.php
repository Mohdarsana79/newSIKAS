...
return new class extends Migration
{
    ...
    {
        // 1. kinerja_silpa_penerimaan_danas
        Schema::create('kinerja_silpa_penerimaan_danas', function (Blueprint $table) {
            $table->id();
        ...
        // 2. kinerja_silpa_penarikan_tunais
        Schema::create('kinerja_silpa_penarikan_tunais', function (Blueprint $table) {
            $table->id();
            $table->foreignId('kinerja_silpa_penganggaran_id')->constrained('kinerja_silpa_penganggarans')->onDelete('cascade');
        ...
        // 3. kinerja_silpa_setor_tunais
        Schema::create('kinerja_silpa_setor_tunais', function (Blueprint $table) {
            $table->id();
            $table->foreignId('kinerja_silpa_penganggaran_id')->constrained('kinerja_silpa_penganggarans')->onDelete('cascade');
        ...
        // 4. kinerja_silpa_status_sts_giros
        Schema::create('kinerja_silpa_status_sts_giros', function (Blueprint $table) {
            $table->id();
            $table->foreignId('kinerja_silpa_penganggaran_id')->constrained('kinerja_silpa_penganggarans')->onDelete('cascade');
        ...
        // 5. kinerja_silpa_buku_kas_umums
        Schema::create('kinerja_silpa_buku_kas_umums', function (Blueprint $table) {
            $table->id();
        ...
        // 6. kinerja_silpa_buku_kas_umum_uraian_details
        Schema::create('kinerja_silpa_buku_kas_umum_uraian_details', function (Blueprint $table) {
            $table->id();
            ...
            // Link ke RKAS SiLPA
            $table->unsignedBigInteger('kinerja_silpa_rkas_id')->nullable();

            $table->timestamps();
        });

        // 7. kinerja_silpa_kwitansis
        Schema::create('kinerja_silpa_kwitansis', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('kinerja_silpa_buku_kas_umum_id')->constrained('kinerja_silpa_buku_kas_umums')->onDelete('cascade');
            $table->foreignId('kinerja_silpa_bku_uraian_detail_id')->constrained('kinerja_silpa_buku_kas_umum_uraian_details')->onDelete('cascade');
            $table->timestamps();
        });

        // Trigger for kinerja_silpa_buku_kas_umum_uraian_details
        DB::unprepared("
            CREATE OR REPLACE FUNCTION kinerja_silpa_auto_hitung_jumlah_bku()
            RETURNS TRIGGER AS $$
            BEGIN
        ...
        DB::unprepared("
            CREATE TRIGGER trg_kinerja_silpa_auto_hitung_jumlah
            BEFORE INSERT OR UPDATE ON kinerja_silpa_buku_kas_umum_uraian_details
            FOR EACH ROW
            EXECUTE FUNCTION kinerja_silpa_auto_hitung_jumlah_bku();
        ");
    }

    public function down(): void
    {
        DB::unprepared("DROP TRIGGER IF EXISTS trg_kinerja_silpa_auto_hitung_jumlah ON kinerja_silpa_buku_kas_umum_uraian_details;");
        DB::unprepared("DROP FUNCTION IF EXISTS kinerja_silpa_auto_hitung_jumlah_bku();");

        Schema::dropIfExists('kinerja_silpa_kwitansis');
        Schema::dropIfExists('kinerja_silpa_buku_kas_umum_uraian_details');
        Schema::dropIfExists('kinerja_silpa_buku_kas_umums');
        Schema::dropIfExists('kinerja_silpa_status_sts_giros');
        Schema::dropIfExists('kinerja_silpa_setor_tunais');
        Schema::dropIfExists('kinerja_silpa_penarikan_tunais');
        Schema::dropIfExists('kinerja_silpa_penerimaan_danas');
    }
};
