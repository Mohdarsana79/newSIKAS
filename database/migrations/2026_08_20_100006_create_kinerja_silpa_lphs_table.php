...
return new class extends Migration
{
    ...
    {
        Schema::create('kinerja_silpa_lphs', function (Blueprint $table) {
                        $table->id();
            $table->foreignId('sekolah_id')->constrained('sekolahs');
            $table->foreignId('kinerja_silpa_penganggaran_id')->constrained('kinerja_silpa_penganggarans');
    ...
    {
        Schema::dropIfExists('kinerja_silpa_lphs');
    }
};
