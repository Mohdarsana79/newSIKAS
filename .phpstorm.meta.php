...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.connections.pgsql.dump.dump_binary_path' => 'string',
            'database.connections.pgsql.dump.use_single_transaction' => 'boolean',
            'database.connections.pgsql.dump.timeout' => 'integer',
            ...
            'filesystems.links.C:\laragon\www\newSIKAS\public\storage' => 'string',
...
'database.connections.pgsql.dump.dump_binary_path','database.connections.pgsql.dump.use_single_transaction','database.connections.pgsql.dump.timeout','database.connections.sqlsrv.driver','database.connections.sqlsrv.url',
...
'filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\newSIKAS\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'sanctum.csrf-cookie','dashboard','dashboard.data',
'profile.edit','profile.update','profile.toggle-security','profile.generate-security-code','penganggaran.index',
'penganggaran.create','penganggaran.store','penganggaran.show','penganggaran.edit','penganggaran.update',
'penganggaran.destroy','penganggaran.update-tanggal-perubahan','penganggaran.update-tanggal-cetak','rkas.updateGroup','rkas.check-previous-perubahan',
'rkas.copy-previous-perubahan','rkas.destroyGroup','rkas.index','rkas.store','rkas.getEditData',
'rkas.update','rkas.destroy','rkas.summary','rkas.export-pdf','rkas.export-tahapan-v1-pdf',
'rkas.export-tahapan-v1-excel','rkas.export-tahapan-excel','rkas.export-rekap-pdf','rkas.export-lembar-kerja-pdf','rkas.export-bulanan-pdf',
'rkas.export-rincian-pdf','rkas.export-rincian-excel','rkas-perubahan.index','rkas-perubahan.salin','rkas-perubahan.store',
'rkas-perubahan.edit','rkas-perubahan.show','rkas-perubahan.update','rkas-perubahan.destroy','rkas-perubahan.destroy-all',
'rkas-perubahan.destroy-penganggaran','rkas-perubahan.summary','rkas-perubahan.logs','rkas-perubahan.export-pdf','rkas-perubahan.export-tahapan-excel',
'rkas-perubahan.export-tahapan-v1-pdf','rkas-perubahan.export-rekap-pdf','rkas-perubahan.export-lembar-kerja-pdf','rkas-perubahan.export-bulanan-pdf','rkas-perubahan.export-rincian-pdf',
'rkas-perubahan.export-rincian-excel','penatausahaan.index','penatausahaan.rekapitulasi','penatausahaan.bku','penatausahaan.get-id',
'penatausahaan.get-data','bku.rekap','penerimaan-dana.store','penerimaan-dana.destroy','sts.bayar',
'sts.update-bayar','api.sts.by-tahun','api.sts.years','api.sts.add-to-bkp','sts.index',
'sts.create','sts.store','sts.show','sts.edit','sts.update',
'sts.destroy','sekolah-profile.upload-kop','sekolah-profile.delete-kop','sekolah-profile.index','sekolah-profile.create',
'sekolah-profile.store','sekolah-profile.show','sekolah-profile.edit','sekolah-profile.update','sekolah-profile.destroy',
'kode-kegiatan.download-template','kode-kegiatan.import','kode-kegiatan.index','kode-kegiatan.create','kode-kegiatan.store',
'kode-kegiatan.show','kode-kegiatan.edit','kode-kegiatan.update','kode-kegiatan.destroy','rekening-belanja.download-template',
'rekening-belanja.import','rekening-belanja.index','rekening-belanja.create','rekening-belanja.store','rekening-belanja.show',
'rekening-belanja.edit','rekening-belanja.update','rekening-belanja.destroy','arkas-tools.index','arkas-tools.search',
'arkas-tools.get-path','arkas-tools.save-path','referensi-kode.index','referensi-kode.fetch','referensi-kode.sync',
'laporan.index','backup.index','backup.create','backup.restore','backup.download',
'backup.delete','backup.validate-password','backup.reset','integrasi.api.index','integrasi.api.update',
'integrasi.api.test-connection','integrasi.sync.index','integrasi.sync.preview','integrasi.sync.store','penarikan-tunai.store',
'penarikan-tunai.destroy','setor-tunai.store','setor-tunai.destroy','bku.store','bku.destroy',
'bku.tutup','bku.reopen','bku.lapor-pajak','bku.destroy-period','api.bku.uraian',
'api.bku.trk-saldo-awal.get','api.bku.trk-saldo-awal.save','api.bku.kegiatan-rekening','api.bku.search-toko','fitur-pelengkap.api.spmth.index',
'fitur-pelengkap.api.spmth.store','fitur-pelengkap.api.spmth.calculate','fitur-pelengkap.api.spmth.tahun','fitur-pelengkap.api.spmth.update','fitur-pelengkap.api.spmth.destroy',
'fitur-pelengkap.api.sptj.index','fitur-pelengkap.api.sptj.store','fitur-pelengkap.api.sptj.update','fitur-pelengkap.api.sptj.destroy','fitur-pelengkap.api.sptj.calculate',
'fitur-pelengkap.api.sptj.tahun','fitur-pelengkap.api.sp2b.index','fitur-pelengkap.api.sp2b.store','fitur-pelengkap.api.sp2b.update','fitur-pelengkap.api.sp2b.destroy',
'fitur-pelengkap.api.sp2b.calculate','fitur-pelengkap.api.sp2b.tahun','fitur-pelengkap.api.lph.index','fitur-pelengkap.api.lph.store','fitur-pelengkap.api.lph.update',
'fitur-pelengkap.api.lph.destroy','fitur-pelengkap.api.lph.calculate','fitur-pelengkap.api.lph.tahun','api.kwitansi.tahun','api.kwitansi.check-available',
'api.kwitansi.debug-count','api.kwitansi.search','kwitansi.generate-batch','kwitansi.delete-all','kwitansi.preview',
'kwitansi.preview2','kwitansi.pdf','kwitansi.pdf2','kwitansi.download-all','kwitansi.download-all2',
'kwitansi.index','kwitansi.create','kwitansi.store','kwitansi.show','kwitansi.edit',
'kwitansi.update','kwitansi.destroy','api.tanda-terima.tahun','api.tanda-terima.check-available','api.tanda-terima.search',
'tanda-terima.generate-batch','tanda-terima.delete-all','tanda-terima.preview','tanda-terima.pdf','tanda-terima.download-all',
'tanda-terima.index','tanda-terima.create','tanda-terima.store','tanda-terima.show','tanda-terima.edit',
'tanda-terima.update','tanda-terima.destroy','dokumen.index','api.dokumen.data','dokumen.store',
'dokumen.destroy','laporan.spmth.pdf','laporan.sptj.pdf','laporan.sp2b.pdf','laporan.lph.pdf',
'api.bkp-bank.data','api.bkp-pembantu.data','api.bkp-umum.data','api.bkp-pajak.data','api.bkp-rob.data',
'api.bkp-reg.data','api.ba.data','api.realisasi.data','api.realisasi.rekening','bkp-bank.cetak',
'bkp-bank.excel','bkp-pembantu.cetak','bkp-pembantu.excel','bkp-umum.cetak','bkp-umum.excel',
'bkp-pajak.cetak','bkp-pajak.excel','bkp-rob.cetak','bkp-reg.cetak','ba.cetak',
'realisasi.cetak','rek-realisasi.cetak','register','login','password.request','password.otp.send','password.otp.verify','password.otp.reset',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','storage.local',);
        registerArgumentsSet('views', 
'app','emails.otp','errors.404','errors.500','errors.503',
'kwitansi.download-all','kwitansi.pdf','laporan.berita_acara_pemeriksaan_kas_pdf','laporan.bkp_bank_excel','laporan.bkp_bank_pdf',
'laporan.bkp_pajak_excel','laporan.bkp_pajak_pdf','laporan.bkp_pembantu_tunai_excel','laporan.bkp_pembantu_tunai_pdf','laporan.bkp_umum_excel',
'laporan.bkp_umum_pdf','laporan.lph_pdf','laporan.partials.bkp-bank-table','laporan.partials.bkp-pembantu-table','laporan.partials.bkp-umum-table',
'laporan.registrasi_penutupan_kas_pdf','laporan.rek_realisasi_pdf','laporan.rekapitulasi_realisasi_pdf','laporan.rka_rincian_exel','laporan.rka_rincian_pdf',
'laporan.rka_tahapan_v_1_pdf','laporan.rob_pdf','laporan.sp2b_pdf','laporan.spmth_pdf','laporan.sptj_pdf',
'pelengkap.download_all_dua_pdf','pelengkap.download_all_pdf','pelengkap.download_all_tanda_terima_pdf','pelengkap.kwitansi_dua_pdf','pelengkap.kwitansi_pdf',
'pelengkap.tanda_terima_pdf','rka_bulanan_all_pdf','rka_bulanan_pdf','rka_lembar_kerja_pdf','rka_rekap_pdf',
'rka_tahapan_pdf','rkas_perubahan_bulanan_pdf','rkas_perubahan_lembar_kerja_pdf','rkas_perubahan_rekap_pdf','rkas_perubahan_tahapan_pdf',
...
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.laragon.www.newSIKAS.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','ARKAS_DB_PATH',);
