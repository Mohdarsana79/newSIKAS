...
use App\Http\Controllers\NotificationController;
    ...
    Route::put('/rkas/{id}/rincian-pencairan', [RkasController::class, 'updateRincianPencairan'])->name('rkas.update-rincian-pencairan');
    Route::post('/rkas/{id}/gabung-rincian', [RkasController::class, 'gabungRincian'])->name('rkas.gabung-rincian');
    Route::put('/rkas/{id}/edit-gabung-rincian', [RkasController::class, 'editGabungRincian'])->name('rkas.edit-gabung-rincian');
    Route::post('/rkas/{id}/ungabung-rincian', [RkasController::class, 'ungabungRincian'])->name('rkas.ungabung-rincian');
    Route::delete('/rkas/{id}', [RkasController::class, 'destroy'])->name('rkas.destroy');
    Route::get('/rkas/{id}/available-kwitansi', [RkasController::class, 'getAvailableKwitansi'])->name('rkas.available-kwitansi');
    Route::put('/rkas/{id}/update-kwitansi', [RkasController::class, 'updateKwitansi'])->name('rkas.update-kwitansi');
    ...
    Route::get('/rkas/{id}/export-alur-kas-pdf', [RkasController::class, 'exportAlurKasPdf'])->name('rkas.export-alur-kas-pdf');
    Route::get('/rkas/{id}/export-alur-kas-excel', [RkasController::class, 'exportAlurKasExcel'])->name('rkas.export-alur-kas-excel');
    Route::get('/rkas/{id}/export-rp-pdf', [RkasController::class, 'exportRpPdf'])->name('rkas.export-rp-pdf');
    Route::get('/rkas/{id}/export-rp-excel', [RkasController::class, 'exportRpExcel'])->name('rkas.export-rp-excel');
    ...
    Route::put('/rkas-perubahan/{id}/rincian-pencairan', [RkasPerubahanController::class, 'updateRincianPencairan'])->name('rkas-perubahan.update-rincian-pencairan');
    Route::post('/rkas-perubahan/{id}/gabung-rincian', [RkasPerubahanController::class, 'gabungRincian'])->name('rkas-perubahan.gabung-rincian');
    Route::put('/rkas-perubahan/{id}/edit-gabung-rincian', [RkasPerubahanController::class, 'editGabungRincian'])->name('rkas-perubahan.edit-gabung-rincian');
    Route::post('/rkas-perubahan/{id}/ungabung-rincian', [RkasPerubahanController::class, 'ungabungRincian'])->name('rkas-perubahan.ungabung-rincian');
    ...
    Route::get('/rkas-perubahan/{id}/available-kwitansi', [RkasPerubahanController::class, 'getAvailableKwitansi'])->name('rkas-perubahan.available-kwitansi');
    Route::put('/rkas-perubahan/{id}/update-kwitansi', [RkasPerubahanController::class, 'updateKwitansi'])->name('rkas-perubahan.update-kwitansi');
    ...
    Route::get('/rkas-perubahan/{id}/export-alur-kas-pdf', [RkasPerubahanController::class, 'exportAlurKasPdf'])->name('rkas-perubahan.export-alur-kas-pdf');
    Route::get('/rkas-perubahan/{id}/export-alur-kas-excel', [RkasPerubahanController::class, 'exportAlurKasExcel'])->name('rkas-perubahan.export-alur-kas-excel');
    Route::get('/rkas-perubahan/{id}/export-rp-pdf', [RkasPerubahanController::class, 'exportRpPdf'])->name('rkas-perubahan.export-rp-pdf');
    Route::get('/rkas-perubahan/{id}/export-rp-excel', [RkasPerubahanController::class, 'exportRpExcel'])->name('rkas-perubahan.export-rp-excel');
    ...
    Route::get('/laporan', function () {
        $variant = app('variant') ?? 'reguler';
        return Inertia::render('FiturPelengkap/Laporan/Index', [
            'variant' => $variant,
            'routePrefix' => \App\Config\VariantConfig::routePrefix($variant),
            'penganggaranFk' => \App\Config\VariantConfig::penganggaranFk($variant)
        ]);
    })->name('laporan.index');
    ...
    Route::get('/api/bku/search-penerima', [BukuKasUmumController::class, 'searchPenerima'])->name('api.bku.search-penerima');
    ...
    Route::prefix('fitur-pelengkap')->group(function () {
        // SPMTH API
