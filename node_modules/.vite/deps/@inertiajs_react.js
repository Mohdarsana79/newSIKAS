...
function useForm(...args) {
  ...
  const excludeKeysRef = (0, import_react8.useRef)([]);
  const [data, setData2] = rememberKey ? useRemember(defaults2, `${rememberKey}:data`, excludeKeysRef) : (0, import_react8.useState)(defaults2);
